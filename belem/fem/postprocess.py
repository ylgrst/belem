...
def create_plastic_strain_and_principal_stress_data(dataset: fd.DataSet) -> tuple[npt.NDArray[np.float_], npt.NDArray[np.float_]]:
...
def get_stress_strain_at_plasticity_threshold(stress_array: npt.NDArray[np.float_], plasticity_array: npt.NDArray[np.float_], plasticity_threshold: float):
...
def plot_stress_strain(stress_array: npt.NDArray[np.float_], strain_array: npt.NDArray[np.float_], figname: str = "stress_strain.png"):
    plt.figure()
...
def plot_hardening(stress_array: npt.NDArray[np.float_], plasticity_array: npt.NDArray[np.float_], figname: str = "hardening.png"):
    plt.figure()
...
def plot_yield_surface(tension_data: tuple[npt.NDArray[np.float_], npt.NDArray[np.float_]],
                          ...
                          plasticity_threshold: float, figname: str = "stress_at_Ep.png"):


    stress_at_plastic_strain_threshold_tension = get_stress_strain_at_plasticity_threshold(tension_data[1], tension_data[0], plasticity_threshold)
    stress_at_plastic_strain_threshold_compression = get_stress_strain_at_plasticity_threshold(compression_data[1], compression_data[0], plasticity_threshold)
    stress_at_plastic_strain_threshold_biaxial_tension = get_stress_strain_at_plasticity_threshold(biaxial_tension_data[1], biaxial_tension_data[0], plasticity_threshold)
    stress_at_plastic_strain_threshold_biaxial_compression = get_stress_strain_at_plasticity_threshold(biaxial_compression_data[1], biaxial_compression_data[0], plasticity_threshold)
    stress_at_plastic_strain_threshold_shear = get_stress_strain_at_plasticity_threshold(shear_data[1], shear_data[0], plasticity_threshold)
    ...
    plot_data_x = [stress_at_plastic_strain_threshold_tension[0], stress_at_plastic_strain_threshold_biaxial_tension[0], 0.0, -stress_at_plastic_strain_threshold_shear[0], stress_at_plastic_strain_threshold_compression[0], stress_at_plastic_strain_threshold_biaxial_compression[0], 0.0, stress_at_plastic_strain_threshold_shear[0], stress_at_plastic_strain_threshold_tension[0]]
    plot_data_y = [0.0, stress_at_plastic_strain_threshold_biaxial_tension[1], stress_at_plastic_strain_threshold_tension[0], -stress_at_plastic_strain_threshold_shear[1], 0.0, stress_at_plastic_strain_threshold_biaxial_compression[1], -stress_at_plastic_strain_threshold_tension[0], stress_at_plastic_strain_threshold_shear[1], 0.0]
